import type { AudioTerrainSetting } from '@/src/scene/scenes/audioTerrain/setting';
...
export function audioTerrainSettings(
    ...
    settingsFolder
        .add(settings, 'tileSize', 1.0, 100.0)
        .name('Tile Size')
        .onChange((value: number) => {
    ...
    settingsFolder
        .add(settings, 'scrollSpeed', 0.0, 0.02)
        .name('Scroll Speed')
        .onChange((value: number) => {
    ...
    settingsFolder
        .add(settings, 'audioScrollMultiplier', 0.0, 2.0)
        .name('Audio Scroll Boost')
        .onChange((value: number) => {
    ...
    // Terrain Shape
    settingsFolder
        .add(settings, 'mountainHeight', 10, 100)
    ...
    settingsFolder
        .add(settings, 'noiseScale', 0.01, 0.2)
    ...
    settingsFolder
        .add(settings, 'audioHeightMultiplier', 0.0, 2.0)
        .name('Audio Height Boost')
        .onChange((value: number) => {
    ...
    // Camera
    settingsFolder
        .add(settings, 'cameraHeight', 50, 250)
        .name('Camera Height')
        .onChange((value: number) => {
    ...
    settingsFolder
        .add(settings, 'cameraDistance', 5, 50)
    ...
    settingsFolder
        .add(settings, 'horizonOffset', -100, 300)
    ...
    settingsFolder
        .add(settings, 'lineWidth', 0.5, 4.0)
        .name('Line Width')
        .onChange((value: number) => {
    ...
    settingsFolder
        .add(settings, 'glowIntensity', 0.0, 1.0)
        .name('Glow Intensity')
        .onChange((value: number) => {
    ...
    // Terrain Colors
    settingsFolder
        .add(settings, 'terrainLowR', 0.0, 1.0)
        .name('Low Color Red')
        .onChange((value: number) => {
    ...
    settingsFolder
        .add(settings, 'terrainLowG', 0.0, 1.0)
    ...
    settingsFolder
        .add(settings, 'terrainLowB', 0.0, 1.0)
        .name('Low Color Blue')
        .onChange((value: number) => {
    ...
    settingsFolder
        .add(settings, 'terrainHighR', 0.0, 1.0)
        .name('High Color Red')
        .onChange((value: number) => {
    ...
    settingsFolder
        .add(settings, 'terrainHighG', 0.0, 1.0)
    ...
    settingsFolder
        .add(settings, 'terrainHighB', 0.0, 1.0)
