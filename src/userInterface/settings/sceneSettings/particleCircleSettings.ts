import type { ParticleCircleSetting } from '@/src/scene/scenes/particleCircle/setting';
...
export function particleCircleSettings(
    ...
    spectrumFolder
        .add(settings, 'musicColorInfluenceReducer', 1000, 100000)
    ...
    spectrumFolder
        .add(settings, 'musicScale', 0.5, 3.0)
        .name('Audio Position Scale')
        .onChange((value: number) => {
    ...
    geometryFolder
        .add(settings, 'innerRadiusDivisor', 100, 5000)
    ...
    geometryFolder
        .add(settings, 'particleWidth', 0.01, 0.5)
        .name('Particle Size')
        .onChange((value: number) => {
    ...
    geometryFolder
        .add(settings, 'sizeMultiplier', 0.0, 2.0)
    ...
    perfFolder
        .add(settings, 'maxParticles', 64, 512)
        .step(1)
        .name('Max Particles')
        .onChange((value: number) => {
    ...
    effectsFolder
        .add(settings, 'glowThreshold', 0, 20)
        .name('Glow Threshold')
        .onChange((value: number) => {
    ...
    effectsFolder
        .add(settings, 'strokeWidth', 0.5, 5)
        .name('Stroke Width')
        .onChange((value: number) => {
