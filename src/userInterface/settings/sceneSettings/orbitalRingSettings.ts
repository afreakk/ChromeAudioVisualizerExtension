import type { OrbitalRingSetting } from '@/src/scene/scenes/orbitalRing/setting';
...
export function orbitalRingSettings(
    ...
    settingsFolder
        .add(settings, 'baseRadius', 0.1, 0.5)
        .name('Base Radius')
        .onChange((value: number) => {
    ...
    settingsFolder
        .add(settings, 'audioRadiusMultiplier', 0.1, 0.8)
        .name('Audio Radius Scale')
        .onChange((value: number) => {
    ...
    // Dots
    settingsFolder
        .add(settings, 'dotSize', 0.005, 0.05)
        .name('Dot Size')
        .onChange((value: number) => {
    ...
    settingsFolder
        .add(settings, 'dotSizeAudioScale', 0, 0.05)
        .name('Dot Audio Scale')
        .onChange((value: number) => {
    ...
    // Animation
    settingsFolder
        .add(settings, 'rotationSpeed', 0, 1)
        .name('Rotation Speed')
        .onChange((value: number) => {
    ...
    settingsFolder
        .add(settings, 'trailFade', 0.05, 0.5)
        .name('Trail Fade')
        .onChange((value: number) => {
