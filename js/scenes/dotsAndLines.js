...
AudioScenes.DotsAndLines = function()
{
    this.name = "DotsAndLines";
};
AudioScenes.DotsAndLines.prototype.getClr = function(rgbS,scaled_average_c)
{
    return rgbToHex(
...
AudioScenes.DotsAndLines.prototype.parseSettings = function(preset)
{
	parseSettings(this,DotsAndLinesSettings, preset);
};
AudioScenes.DotsAndLines.prototype.clearBg = function(clearColored)
{
	if(clearColored)
...
AudioScenes.DotsAndLines.prototype.update = function()
{
